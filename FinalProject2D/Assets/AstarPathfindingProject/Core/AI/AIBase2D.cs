...
namespace Pathfinding
{
	...
	///
	/// See: <see cref="Pathfinding.AIPath2D"/>
	/// See: <see cref="Pathfinding.RichAI"/>
	/// See: <see cref="Pathfinding.IAstarAI"/> (all movement scripts implement this interface)
	/// </summary>
	[RequireComponent(typeof(Seeker))]
	public abstract class AIBase2D : VersionedMonoBehaviour
	{
		[UnityEngine.Serialization.FormerlySerializedAs("isRotating")]
		public bool isRotateOnly = false;
		...
		/// </summary>
		public Quaternion rotation { get { return updateRotation ? _rotatorTr.rotation : simulatedRotation; } }
		...
		/// <summary>##EDITED## Cached Transform rotator component</summary>
		protected Transform _rotatorTr;
		...
		{
			tr = transform;
			_rotatorTr = transform.Find("Rotator");
		...
		void FinalizePosition(Vector3 nextPosition)
		{
			...
			if (controller != null && controller.enabled && updatePosition && !isRotateOnly)
			{
			...
			if ((positionDirty1 || positionDirty2) && updatePosition && !isRotateOnly)
			{
