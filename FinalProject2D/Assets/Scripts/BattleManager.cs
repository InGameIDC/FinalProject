...
public class BattleManager : MonoBehaviour
{
    ...
    TouchInputManager _inputManager;
    MouseInputManager _inputMouseManager;
    ...
    {
        _inputManager = transform.GetComponent<TouchInputManager>();
    ...
    {
        _inputMouseManager = transform.GetComponent<MouseInputManager>();
