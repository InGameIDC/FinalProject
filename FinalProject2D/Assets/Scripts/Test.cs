...
public static class Test ///Author: Ilan
{
    ...
    {
        yield return MarkCircleAtPos(pos, duration, 0.1f, 0.1f, Color.red);
    }

    public static IEnumerator MarkCircleAtPos(Vector3 pos, float duration, float radius, float lineWidth, Color color)
    {
        GameObject circle = new GameObject();
        pos.y += 0.05f;
        circle.transform.position = pos;
        DrawCircle(circle, radius, lineWidth, color);
